export type Char = { kana: string; romaji: string };
export type CharCell = Char | null;
export type KanaSectionId = "basic" | "voiced" | "semiVoiced";
...
export const HIRAGANA_SECTIONS: KanaSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      [{ kana: "ざ", romaji: "za" }, { kana: "じ", romaji: "zi" }, { kana: "ず", romaji: "zu" }, { kana: "ぜ", romaji: "ze" }, { kana: "ぞ", romaji: "zo" }],
...
export const KATAKANA_SECTIONS: KanaSection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      [{ kana: "ザ", romaji: "za" }, { kana: "ジ", romaji: "zi" }, { kana: "ズ", romaji: "zu" }, { kana: "ゼ", romaji: "ze" }, { kana: "ゾ", romaji: "zo" }],
...
export const HIRAGANA: CharCell[][] = HIRAGANA_SECTIONS.flatMap(
  (section) => section.rows,
);
export const KATAKANA: CharCell[][] = KATAKANA_SECTIONS.flatMap(
  (section) => section.rows,
);

export const HIRAGANA_FLAT: Char[] = HIRAGANA.flat().filter(Boolean) as Char[];
export const KATAKANA_FLAT: Char[] = KATAKANA.flat().filter(Boolean) as Char[];
