const ja = {
  ...
  settings: {
    ...
    language: {
      ...
      englishAustralia: "英語 (オーストラリア)",
      englishNewZealand: "英語 (ニュージーランド)",
      englishIreland: "英語 (アイルランド)",
      englishCanada: "英語 (カナダ)",
      korean: "韓国語",
      japanese: "日本語",
      spanish: "スペイン語",
      french: "フランス語",
  ...
  dashboard: {
    ...
    popQuiz: {
      title: "ポップクイズ",
      subtitle: "{{course}} - {{day}}日目",
      subtitleFallback: "クイックマッチを始めるには、まずコースを選択してください。",
      loading: "ポップクイズを読み込み中...",
      progress: "{{current}}/{{total}} マッチ",
      wrongAttempts: "ミス {{count}}回",
      elapsed: "{{time}}",
      pageIndicator: "{{current}} / {{total}}ページ",
      unavailable: {
        title: "ポップクイズは利用できません",
  ...
  auth: {
    ...
    passwordReset: {
      ...
      forgotSubtitle: "パスワードリセットリンクを受け取るメールアドレスを入力してください。",
      resetTitle: "パスワードリセット",
      resetSubtitle: "パスワードリセットメールを開いてから新しいパスワードを設定してください。",
      newPasswordTitle: "新しいパスワードを設定",
      newPasswordSubtitle: "アカウントに使用する新しいパスワードを入力してください。",
      emailPlaceholder: "メール",
      sendEmail: "パスワードリセットメールを送信",
      sendingEmail: "メール送信中...",
      resendEmail: "メールを再送信",
      checkInbox: "続けるにはパスワードリセットメールのリンクを開いてください。",
      verifyingCode: "パスワードリセットリンクを確認中...",
      invalidLinkToast:
        "このパスワードリセットリンクは無効または期限切れです。新しいリンクをリクエストしてください。",
      verifyFailed:
        "このパスワードリセットリンクは無効または期限切れです。新しいメールをリクエストしてください。",
      sendFailed: "パスワードリセットメールの送信に失敗しました。再試行してください。",
      emailRequired: "メールアドレスを入力してください。",
      emailInvalid: "有効なメールアドレスを入力してください。",
      emailSent: "{{email}}にパスワードリセットメールを送信しました。",
      ...
      minLengthValidation: "パスワードは6文字以上にしてください。",
      mismatchValidation: "パスワードが一致している必要があります。",
      submit: "パスワードをリセット",
      submitting: "パスワードリセット中...",
      resetSuccess: "パスワードのリセットに成功しました。再度サインインしてください。",
      successToast: "パスワードが正常に変更されました。ログインできます。",
  ...
  profile: {
    ...
    resetPassword: {
      ...
      sending: "送信中...",
      emailSent: "{{email}}にパスワードリセットメールを送信しました。",
      emailMissing: "このアカウントで利用できるメールアドレスがありません。",
      sendFailed: "パスワードリセットメールの送信に失敗しました。再試行してください。",
    },
    sections: {
      accountInfo: "アカウント情報",
