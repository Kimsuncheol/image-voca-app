const ja = {
  ...
  calendar: {
    ...
    detail: {
      ...
      loadingStudiedCourses: "学習したコースを読み込み中...",
      noStudiedCourses: "この日に完了した単語学習はありません。",
      dayLabel: "{{count}}日目",
      wordsProgress: "{{learned}} / {{total}} 単語",
      noQuiz: "クイズなし",
      yes: "はい",
      no: "いいえ",
    },
  ...
  tutorial: {
    ...
    slides: {
      dashboard: {
        title: "ダッシュボードから始めましょう",
        body: "毎日の学習状況を確認し、すぐに使える学習機能へ移動して、今の進み具合をひと目で把握できます。",
      },
      days: {
        title: "日を選んで順番に進めます",
        body: "コースを開いて日付グリッドを確認し、前の日を完了しながら順番に学習を進められます。",
      },
      vocabulary: {
        title: "カードをめくりながら学習します",
        body: "単語やコロケーションをカード単位で学び、大事な項目を保存しながら継続的な学習リズムを作れます。",
      },
      wordBank: {
        title: "単語帳で保存した単語を復習できます",
        body: "保存したコースを開いて集めた単語を見直し、難しい語彙を必要なときにいつでも復習できます。",
      },
      calendar: {
        title: "カレンダーで学習履歴を確認できます",
        body: "学習した日を振り返り、連続学習の進捗を確認し、完了した単語学習セッションを履歴から開けます。",
      },
      elementaryJapanese: {
        title: "初級日本語モジュールを活用しましょう",
        body: "かな、助数詞、あいさつ、接頭辞・接尾辞のモジュールで、日本語学習の土台をしっかり固められます。",
      },
    },
  },
  courses: {
