const ko = {
  ...
  tutorial: {
    ...
    slides: {
      dashboard: {
        title: "대시보드에서 시작하세요",
        body: "하루 학습 현황을 확인하고, 빠른 학습 요소로 바로 이동하며, 지금의 학습 흐름을 한눈에 볼 수 있습니다.",
      },
      days: {
        title: "일차를 선택하고 순서대로 학습하세요",
        body: "코스를 열어 일차 그리드를 확인하고, 이전 일차를 완료하면서 순서대로 진도를 진행하세요.",
      },
      vocabulary: {
        title: "카드를 넘기며 단어를 익히세요",
        body: "단어와 연어를 카드 단위로 학습하고, 중요한 항목을 저장하며, 꾸준한 학습 리듬을 만들어 보세요.",
      },
      wordBank: {
        title: "단어장에서 저장한 단어를 다시 보세요",
        body: "저장한 코스를 열어 모아둔 단어를 복습하고, 어려운 어휘를 필요할 때마다 다시 확인할 수 있습니다.",
      },
      calendar: {
        title: "캘린더에서 학습 기록을 확인하세요",
        body: "어떤 날 공부했는지 보고, 연속 학습 현황을 확인하며, 완료한 단어 학습 기록도 다시 열 수 있습니다.",
      },
      elementaryJapanese: {
        title: "기초 일본어 모듈을 탐색하세요",
        body: "가나, 조수사, 인사, 접두/접미 모듈을 활용해 일본어 학습의 기초를 탄탄하게 다질 수 있습니다.",
      },
    },
  },
  courses: {
