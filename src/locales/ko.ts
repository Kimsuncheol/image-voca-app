const ko = {
  ...
  settings: {
    ...
    language: {
      ...
      englishAustralia: "영어 (호주)",
      englishNewZealand: "영어 (뉴질랜드)",
      englishIreland: "영어 (아일랜드)",
      englishCanada: "영어 (캐나다)",
      korean: "한국어",
      japanese: "일본어",
      spanish: "스페인어",
      french: "프랑스어",
  ...
  dashboard: {
    ...
    popQuiz: {
      title: "팝 퀴즈",
      subtitle: "{{course}} - {{day}}일차",
      subtitleFallback: "오늘의 빠른 매칭을 위해 먼저 코스를 선택하세요.",
      loading: "팝 퀴즈를 불러오는 중...",
      progress: "{{current}}/{{total}} 매칭",
      wrongAttempts: "오답 {{count}}회",
      elapsed: "{{time}}",
      pageIndicator: "{{current}} / {{total}} 페이지",
      unavailable: {
        title: "팝 퀴즈를 이용할 수 없습니다",
  ...
  auth: {
    ...
    passwordReset: {
      forgotTitle: "비밀번호 찾기",
      forgotSubtitle: "비밀번호 재설정 링크를 받을 이메일을 입력하세요.",
      resetTitle: "비밀번호 재설정",
      resetSubtitle: "비밀번호 재설정 이메일을 연 뒤 새 비밀번호를 설정하세요.",
      newPasswordTitle: "새 비밀번호 설정",
      newPasswordSubtitle: "계정에 사용할 새 비밀번호를 입력하세요.",
      emailPlaceholder: "이메일",
      sendEmail: "비밀번호 재설정 이메일 보내기",
      sendingEmail: "이메일 전송 중...",
      resendEmail: "이메일 다시 보내기",
      checkInbox: "계속하려면 비밀번호 재설정 이메일의 링크를 열어주세요.",
      verifyingCode: "비밀번호 재설정 링크 확인 중...",
      invalidLinkToast:
        "비밀번호 재설정 링크가 유효하지 않거나 만료되었습니다. 새 링크를 요청하세요.",
      verifyFailed:
        "비밀번호 재설정 링크가 유효하지 않거나 만료되었습니다. 이메일을 다시 요청하세요.",
      sendFailed: "비밀번호 재설정 이메일 전송에 실패했습니다. 다시 시도하세요.",
      emailRequired: "이메일 주소를 입력하세요.",
      emailInvalid: "유효한 이메일 주소를 입력하세요.",
      emailSent: "{{email}}로 비밀번호 재설정 이메일을 보냈습니다.",
      ...
      minLengthValidation: "비밀번호는 6자 이상이어야 합니다.",
  ...
  profile: {
    ...
    resetPassword: {
      ...
      sending: "전송 중...",
      emailSent: "{{email}}로 비밀번호 재설정 이메일을 보냈습니다.",
      emailMissing: "이 계정에서 사용할 수 있는 이메일 주소가 없습니다.",
      sendFailed: "비밀번호 재설정 이메일 전송에 실패했습니다. 다시 시도하세요.",
    },
    sections: {
      accountInfo: "계정 정보",
