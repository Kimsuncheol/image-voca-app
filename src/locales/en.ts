const en = {
  ...
  dashboard: {
    ...
    popQuiz: {
      title: "Pop Quiz",
      subtitle: "{{course}} - Day {{day}}",
      subtitleFallback: "Choose a course to unlock today's quick match.",
      loading: "Loading pop quiz...",
      progress: "{{current}}/{{total}} matched",
      wrongAttempts: "{{count}} wrong",
      elapsed: "{{time}}",
      pageIndicator: "Page {{current}} / {{total}}",
      unavailable: {
        title: "Pop quiz unavailable",
        ...
        missingData: "No pop quiz has been generated for this day yet.",
